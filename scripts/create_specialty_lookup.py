"""
Taxonomy/Specialty Code Lookup Helper

Creates a lookup dictionary mapping taxonomy codes to specialty descriptions.
Saves to data/taxonomy_lookup.json for use by the API.

No heavy dependencies required - just Python standard library.
...
def get_taxonomy_mapping():
    """
    Returns comprehensive taxonomy code to description mapping.
    Based on NUCC Healthcare Provider Taxonomy Code Set.
    """
    return {
        # Allopathic & Osteopathic Physicians - Primary Specialties
        ...
        "207RA0201X": "Allergy & Immunology (Internal Medicine)",
        ...
        "207RI0001X": "Clinical & Laboratory Immunology (Internal Medicine)",
        "207RI0008X": "Hepatology",
        "207RI0011X": "Interventional Cardiology",
        "207RI0200X": "Infectious Disease",
        "207RM1200X": "Magnetic Resonance Imaging (Internal Medicine)",
        ...
        "207WX0009X": "Glaucoma Specialist (Ophthalmology)",
        "207WX0107X": "Retina Specialist (Ophthalmology)",
        "207WX0108X": "Uveitis and Ocular Inflammatory Disease (Ophthalmology)",
        "207WX0109X": "Neuro-ophthalmology",
        "207WX0110X": "Pediatric Ophthalmology",
        ...
        "207XX0005X": "Foot and Ankle Surgery (Orthopaedic Surgery)",
        "207XX0801X": "Orthopaedic Surgery of the Spine",
        "207XS0106X": "Orthopaedic Hand Surgery",
        "207XS0114X": "Orthopaedic Sports Medicine",
        ...
        "207YX0007X": "Plastic Surgery within the Head & Neck (Otolaryngology)",
        ...
        "2080I0007X": "Clinical & Laboratory Immunology (Pediatrics)",
        ...
        "2080P0204X": "Pediatric Emergency Medicine (Pediatrics)",
        ...
        "2081N0008X": "Neuromuscular Medicine (Physical Medicine & Rehabilitation)",
        "2081P0004X": "Spinal Cord Injury Medicine",
        "2081P0010X": "Pediatric Rehabilitation Medicine",
        "2081P0301X": "Brain Injury Medicine (Physical Medicine & Rehabilitation)",
        ...
        "2082S0099X": "Plastic Surgery Within the Head and Neck (Plastic Surgery)",
        "2082S0105X": "Surgery of the Hand (Plastic Surgery)",
        "208600000X": "Surgery",
        "2086H0002X": "Hospice and Palliative Medicine (Surgery)",
        "2086S0102X": "Surgical Critical Care",
        "2086S0105X": "Surgery of the Hand (Surgery)",
        ...
        "2084D0003X": "Diagnostic Neuroimaging (Psychiatry & Neurology)",
        "2084F0202X": "Forensic Psychiatry",
        "2084H0002X": "Hospice and Palliative Medicine (Psychiatry & Neurology)",
        "2084N0008X": "Neuromuscular Medicine (Psychiatry & Neurology)",
        ...
        "2085R0001X": "Diagnostic Radiology",
        "2085R0202X": "Diagnostic Ultrasound",
        "2085R0203X": "Radiation Oncology",
        "2085R0204X": "Vascular & Interventional Radiology",
        "2085R0205X": "Radiological Physics",
        "2085B0100X": "Body Imaging (Radiology)",
        ...
        "2085U0001X": "Diagnostic Radiography",
        ...
        "363LN0005X": "Neonatal, Critical Care Nurse Practitioner",
        "363LP0200X": "Pediatric Nurse Practitioner",
        "363LP0222X": "Pediatric Nurse Practitioner, Critical Care",
        ...
        "103TE1000X": "Educational Psychologist",
        ...
        "103TM1700X": "Men & Masculinity Psychologist",
        "103TM1800X": "Mental Retardation & Developmental Disabilities Psychologist",
        "103TP0016X": "Prescribing (Medical) Psychologist",
        "103TP0814X": "Psychoanalysis Psychologist",
        "103TP2700X": "Psychotherapy Psychologist",
        ...
        "1835P1200X": "Pharmacist Clinician (PhC)/ Clinical Pharmacy Specialist",
        "225100000X": "Physical Therapist",
        "2251C2600X": "Cardiovascular Physical Therapist",
        "2251E1300X": "Geriatric Physical Therapist",
        "2251E1200X": "Ergonomics Physical Therapist",
        "2251G0304X": "Hand Physical Therapist",
        "2251H1200X": "Human Factors Physical Therapist",
        "2251H1300X": "Neurologic Physical Therapist",
        "2251N0400X": "Orthopedic Physical Therapist",
        "2251P0200X": "Pediatric Physical Therapist",
        "2251S0007X": "Sports Physical Therapist",
        "2251X0800X": "Women's Health Physical Therapist",
        ...
        "261QF0050X": "Family Planning, Non-Surgical Clinic/Center",
        "261QF0400X": "Federally Qualified Health Center (FQHC)",
        "261QH0100X": "Health Service Clinic/Center",
        "261QM0801X": "Mental Health Center (Including Community Mental Health Center)",
        ...
        "261QP2400X": "Prison Health Center",
        ...
        "282NE0002X": "Military Hospital",
        "282NE1300X": "Emergency Hospital",
        "282NR1301X": "Rural Acute Care Hospital",
        "282NW0100X": "Women's Hospital",
    }


def create_taxonomy_lookup_file(output_dir="data"):
    """Create taxonomy lookup file at data/taxonomy_lookup.json"""
    print("=" * 80)
    print("TAXONOMY CODE LOOKUP GENERATOR")
    print("=" * 80)
    print("\nCreating taxonomy code lookup file...")

    taxonomy_map = get_taxonomy_mapping()
    output_path = Path(output_dir)
    output_path.mkdir(exist_ok=True, parents=True)
    output_file = output_path / "taxonomy_lookup.json"

    with open(output_file, "w") as f:
        json.dump(taxonomy_map, f, indent=2)

    print(f"\n✓ Created: {output_file}")
    print(f"  Total codes: {len(taxonomy_map)}")
    print(f"  File size: {output_file.stat().st_size / 1024:.1f} KB")
    print("\n" + "=" * 80)
    print("SUCCESS! Restart your API server to use the lookup.")
    print("=" * 80)
    return output_file
